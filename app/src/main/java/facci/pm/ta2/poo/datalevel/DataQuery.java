...
public class DataQuery<Object> {
    ...
    public void findInBackground(String property,Object value,int operator, FindCallback<DataObject> callback)
    {
        ...
        Log.d("DEBUG",  String.format("Start calculation thread id: %d",Thread.currentThread().getId()));
        ...
        m_runnable = new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.d("DEBUG",  String.format("body calculation thread id: %d",Thread.currentThread().getId()));
